...
riscv64-unknown-elf-gcc -O0 -march=rv32i -mabi=ilp32 ${TEST_FOLDER_LOCATION}/${C_FILE} -o ${TEST_FOLDER_LOCATION}/test.out
riscv64-unknown-elf-objdump -d ${TEST_FOLDER_LOCATION}/test.out > ${TEST_FOLDER_LOCATION}/disasm
# code ${TEST_FOLDER_LOCATION}/disasm
